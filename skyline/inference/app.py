...
from ouluskyline.inference.pipeline import KneeNetEnsemble
...
@app.route('/skyline/predict/bilateral', methods=['POST'])
def analyze_knee():
    logger = logging.getLogger(f'skyline-backend:app')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--logs', type=str, default='/tmp/skyline.log')
